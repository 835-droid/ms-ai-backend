// Novel Library Page - JavaScript
// Handles all interactions for the novel library listing page
...
(function() {
    ...
    async function loadNovels() {
        ...
        try {
            // Get novels
            const response = await API.getNovels(currentPage, 20);
            ...
            resultsCount.textContent = `${items.length} رواية`;

            renderNovels(items);
            renderPagination(items.length, 20);
