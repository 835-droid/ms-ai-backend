// ----- START OF FILE: backend/MS-AI/internal/data/user/mongo_user_repository.go -----
...
func (r *MongoUserRepository) Create(ctx context.Context, u *coreUser.User, details *coreUser.UserDetails) error {
	...
	// Copy relevant fields to details (only UserDetailsBase fields)
	details.LastLoginAt = u.LastLoginAt
	details.RefreshToken = u.RefreshToken
	details.RefreshTokenExpiresAt = u.RefreshTokenExpiresAt
