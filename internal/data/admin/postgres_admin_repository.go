// ----- START OF FILE: backend/MS-AI/internal/data/admin/postgres_admin_repository.go -----
// internal/data/admin/postgres_admin_repository.go
package admin
...
func NewPostgresAdminRepository(store *pginfra.PostgresStore) admin.Repository {
...
// ----- END OF FILE: backend/MS-AI/internal/data/admin/postgres_admin_repository.go -----
