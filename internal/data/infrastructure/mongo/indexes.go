...
func GetAllIndexConfigs() []IndexConfig {
	return []IndexConfig{
		...
		},
		{
			...
			Indexes: []mongo.IndexModel{
				{
					Keys:    bson.D{{Key: "chapter_id", Value: 1}, {Key: "user_id", Value: 1}},
					Options: options.Index().SetUnique(true),
				},
				{
		...
		},
		{
			...
			Indexes: []mongo.IndexModel{
				{
					Keys:    bson.D{{Key: "chapter_id", Value: 1}, {Key: "manga_id", Value: 1}},
					Options: options.Index(),
				},
				{
					Keys:    bson.D{{Key: "chapter_id", Value: 1}, {Key: "created_at", Value: -1}},
					Options: options.Index(),
				},
			},
		},
		...
		},
		{
			...
			Indexes: []mongo.IndexModel{
				...
				{
					Keys:    bson.D{{Key: "manga_id", Value: 1}, {Key: "viewed_at", Value: -1}},
					Options: options.Index(),
				},
			},
		},
